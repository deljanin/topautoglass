...
export default function LearnMore({
  ...
  return (
    <div className="relative mt-20 min-h-full w-full shadow-[0_0_20px_5px_rgba(0,0,0,0.5)]">
      <div className="flex flex-col items-center px-5 py-32 sm:px-16 lg:px-32 xl:block xl:px-64">
        <h2 className="mb-10 text-center font-cateItalic text-4xl sm:text-5xl md:mb-20 xl:w-2/3 xl:text-left xl:text-6xl">
          {sectionTitle}
        </h2>
