const services = [
  {
    ...
    link: "auto-glass",
    longDescription: [
      "At Top Auto Glass, we offer *complete auto glass replacement* and rock chip repair in Houston to get you back on the road as fast as possible. With years of industry experience, we have refined our windshield replacement process to ensure every job is completed with precision and accuracy.",
  ...
  },
  {
    ...
    link: "window-tinting",
    longDescription: [
      "Aside from *windshield repair in Houston*, we specialize in window tinting to enhance both the look and function of your vehicle. Whether you want to add a subtle tint or go for a fully private, sleek appearance, window tinting is an affordable way to upgrade your car’s style.",
  ...
  },
  {
    ...
    link: "ppf",
    longDescription: [
      "Our team specializes in applying *high-quality PPF in Houston* that provides exceptional protection against scratches, rock chips, and other environmental hazards.",
